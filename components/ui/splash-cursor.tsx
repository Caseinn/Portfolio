  ...
  useEffect(() => {
    ...
    function getWebGLContext(el: HTMLCanvasElement) {
      ...
      let gl: WebGL2RenderingContext | WebGLRenderingContext | null =
        (el.getContext('webgl2', params) as WebGL2RenderingContext | null) || null;

      if (!gl) {
        gl =
          (el.getContext('webgl', params) as WebGLRenderingContext | null) ||
          (el.getContext('experimental-webgl', params) as WebGLRenderingContext | null) ||
          null;
      }
      ...
      // Narrow to union type we’ll carry around
      ...
      if (isWebGL2) {
        ...
        // In WebGL2, OES_texture_float_linear name is valid but optional
        supportLinearFiltering = !!(gl as WebGL2RenderingContext).getExtension(
          'OES_texture_float_linear'
        );
      } else {
        halfFloatExt = (gl as WebGLRenderingContext).getExtension(
      ...
      if (isWebGL2) {
        ...
        // WebGL1 fallback uses RGBA for all
